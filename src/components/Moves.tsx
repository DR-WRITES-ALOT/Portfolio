...
const MOVES: Move[] = [
  {
    keys: ["↓", "↘", "→", "P"],
    name: "HADŌKEN PROTOTYPE",
    desc: "From napkin sketch to a clickable, animated prototype in 72 hours. Fires across the table and ends the debate.",
  ...
  {
    keys: ["←", "↓", "↙", "K"],
    name: "DESIGN-SYSTEM UPPERCUT",
    desc: "Tokens, docs and a11y-first components that lift the whole team. One library, forty developers, zero drift.",
    tag: "SYSTEMS + COMPONENTS",
    dmg: 92,
    color: "#ffe600",
  },
  {
    keys: ["→", "→", "P"],
    name: "DASH DELIVERY",
    desc: "CI pipelines, perf budgets and ruthless code-splitting. Ships at 60fps or it doesn't ship.",
    tag: "PERFORMANCE + DEVEX",
    dmg: 78,
    color: "#6eff8c",
  },
  {
    keys: ["↓", "↙", "←", "P"],
    name: "GLITCH COUNTER",
    desc: "Scroll choreography, shader transitions and micro-interactions that counter a competitor's boring site in one hit.",
    tag: "MOTION + WEBGL",
    dmg: 96,
    color: "#ff2e7e",
  },
  {
    keys: ["QCF", "×2", "P"],
    name: "ULTRA: FULL LAUNCH",
    desc: "Concept → storyboard → design system → code → deploy. The entire combo, executed frame-perfect.",
  ...
  return (
    <section id="moves" className="relative scroll-mt-24 py-20 md:py-28 bg-panel/40 border-y-[3px] border-ink">
      ...
      <div className="relative max-w-7xl mx-auto px-5">
        <SectionHeading index="04" title="SPECIAL MOVES" tag="// services — fighting-game edition" accent="#ff2e7e" />
                ...
                >
                  ...
                  <div className="md:justify-self-end w-full md:w-40">
                    <div className="flex justify-between items-baseline mb-1">
                      <span className="font-display text-lg leading-none text-paper">DMG</span>
                      <span className="font-mono2 text-[10px] font-bold text-mute">{m.dmg}</span>
                    </div>
